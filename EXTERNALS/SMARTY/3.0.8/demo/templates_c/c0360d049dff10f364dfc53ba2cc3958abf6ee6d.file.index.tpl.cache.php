<?php /* Smarty version Smarty-3.0.8, created on 2012-03-29 08:39:19
         compiled from "./templates/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8983827604f748227eb4322-99539678%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '8983827604f748227eb4322-99539678',
  'function' => 
  array (
  ),
  'has_nocache_code' => true,
)); /*/%%SmartyHeaderCode%%*/?>
<?php if (!is_callable('smarty_modifier_capitalize')) include '/home/cchits/test.cchits.net/EXTERNALS/SMARTY/3.0.8/libs/plugins/modifier.capitalize.php';
if (!is_callable('smarty_modifier_date_format')) include '/home/cchits/test.cchits.net/EXTERNALS/SMARTY/3.0.8/libs/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_html_select_date')) include '/home/cchits/test.cchits.net/EXTERNALS/SMARTY/3.0.8/libs/plugins/function.html_select_date.php';
if (!is_callable('smarty_function_html_select_time')) include '/home/cchits/test.cchits.net/EXTERNALS/SMARTY/3.0.8/libs/plugins/function.html_select_time.php';
if (!is_callable('smarty_function_html_options')) include '/home/cchits/test.cchits.net/EXTERNALS/SMARTY/3.0.8/libs/plugins/function.html_options.php';
?><?php echo '/*%%SmartyNocache:8983827604f748227eb4322-99539678%%*/<?php if (!is_callable(\'smarty_modifier_capitalize\')) include \'/home/cchits/test.cchits.net/EXTERNALS/SMARTY/3.0.8/libs/plugins/modifier.capitalize.php\';
if (!is_callable(\'smarty_modifier_date_format\')) include \'/home/cchits/test.cchits.net/EXTERNALS/SMARTY/3.0.8/libs/plugins/modifier.date_format.php\';
?>/*/%%SmartyNocache:8983827604f748227eb4322-99539678%%*/';?>
...
The value of {$Name} is <b><?php echo '/*%%SmartyNocache:8983827604f748227eb4322-99539678%%*/<?php echo $_smarty_tpl->getVariable(\'Name\')->value;?>
/*/%%SmartyNocache:8983827604f748227eb4322-99539678%%*/';?></b>

variable modifier example of {$Name|upper}

<b><?php echo '/*%%SmartyNocache:8983827604f748227eb4322-99539678%%*/<?php echo ((mb_detect_encoding($_smarty_tpl->getVariable(\'Name\')->value, \'UTF-8, ISO-8859-1\') === \'UTF-8\') ? mb_strtoupper($_smarty_tpl->getVariable(\'Name\')->value,SMARTY_RESOURCE_CHAR_SET) : strtoupper($_smarty_tpl->getVariable(\'Name\')->value));?>
/*/%%SmartyNocache:8983827604f748227eb4322-99539678%%*/';?></b>
