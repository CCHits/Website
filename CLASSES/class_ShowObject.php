    ...
    function getSelf()
    {
        if ($this->intShowUrl != 0) {
            if ($this->strShowUrl == "") {
                ...
                if (!empty($remotepath) ||  file_exists(ConfigBroker::getConfig('fileBase', '/var/www/media') . '/' . $this->enumShowType . "/" . $this->intShowUrl . '.mp3')) {
                ...
                if (!empty($remotepath) || file_exists(ConfigBroker::getConfig('fileBase', '/var/www/media') . '/' . $this->enumShowType . "/" . $this->intShowUrl . '.oga')) {
                ...
                if (!empty($remotepath) || file_exists(ConfigBroker::getConfig('fileBase', '/var/www/media') . '/' . $this->enumShowType . "/" . $this->intShowUrl . '.m4a')) {
