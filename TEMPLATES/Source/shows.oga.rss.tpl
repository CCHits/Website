...
{if isset($show.player_data.oga)}
		<enclosure url="{$show.player_data.oga}" length="{$show.player_data.oga_len}" type="audio/oga" />
{/if}
...
{if isset($show.player_data.oga)}
		<mrss-plus:fullwork url="{$show.player_data.oga}" fileSize="{$show.player_data.oga_len}" type="audio/oga" medium="audio" isDefault="true" expression="full" duration="{$show.timeLength}" lang="en">
